...
class SistemaAcionistas {
  List<String> obterAnalisesDesempenho(String dataInicialStr, String dataFinalStr) {
    ...
    for (final analise in analises) {
      if (analise.data.isAtSameMomentAs(dataInicial) && analise.data.isBefore(dataFinal) || analise.data.isAfter(dataInicial) && analise.data.isAtSameMomentAs(dataFinal) || analise.data.isAfter(dataInicial) && analise.data.isBefore(dataFinal)) {
