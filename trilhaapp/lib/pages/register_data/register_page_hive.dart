...
class RegisterHivePage extends StatefulWidget {
  const RegisterHivePage({Key? key}) : super(key: key);

  @override
  State<RegisterHivePage> createState() => _RegisterHivePageState();
}

class _RegisterHivePageState extends State<RegisterHivePage> {
  ...
  void loadData() async {
    ...
    birthDateController.text = userData.userDataDateOfBirth == null ? "" : userData.userDataDateOfBirth.toString();
            ...
            children: [
              ...
              TextFormField(
                ...
                onTap: () async {
                  ...
                  if (date != null) {
                    ...
                    userData.userDataDateOfBirth = DateTime.parse(birthDateController.text);
              ...
              Column(
                children: levels
                    .map((level) => RadioListTile(
                          ...
                          selected: userData.userDataExperienceLevel == level.toString(),
                          groupValue: userData.userDataExperienceLevel,
                          onChanged: (value) {
                            setState(() {
                              userData.userDataExperienceLevel = value.toString();
                            });
                          },
                        ))
                    .toList(),
              ...
              DropdownButtonFormField(
                  ...
                  onChanged: (selectedExperienceTime) {
                    setState(() {
                      userData.userDataExperienceTime = selectedExperienceTime.toString();
                    });
                  },
                  decoration: const InputDecoration(
                    border: OutlineInputBorder(),
              ...
              Slider(
                value: userData.userDataSallary ?? 0,
                min: 1320,
                max: 10000,
                divisions: 500,
              ...
              TextButton(
                onPressed: () async {
                  if (_formKey.currentState!.validate()) {
                    ...
                    userData.userDataDateOfBirth = DateTime.parse(birthDateController.text);
                    userData.userDataExperienceLevel = userData.userDataExperienceLevel;
                    userData.languages = userData.languages;
                    userData.userDataExperienceTime = userData.userDataExperienceTime;
                    userData.userDataSallary = userData.userDataSallary;
